...
const c1 = new Customer({ firstName: "Anousha", lastName: "Baig" }, 27, "female", 4343434333, a1);
c1.display();
c1.bankaccount.debit(500);
console.log();
const a2 = new Bankaccount(500);
const c2 = new Customer({ firstName: "maheen", lastName: "imtiaz" }, 27, "female", 4343434333, a2);
c2.display();
